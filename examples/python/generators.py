...
print '  ... notice all the times are the same because they were all made in the beginning'
...
print '  ... notice all the times are different because they are being made as we loop through'
...
print 'at that point it runs to the first yield, and on subsequent calls continues to run to the next yield\n\n'
